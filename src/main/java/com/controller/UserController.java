...
public class UserController {
    ...
    public BaseResponse<Page<UserVO>> listUserVOByPage(@RequestBody UserQueryRequest userQueryRequest) {
        ...
        IPage<User> userIPage = userService.page(userPage, userService.getQueryWrapper(userQueryRequest));
        // 数据脱敏
        Page<UserVO> userVOPage = new Page<>(pageNum, pageSize, userIPage.getTotal());
        List<UserVO> userVOList = userService.getUserVOList(userIPage.getRecords());
